...
class MatriculaForm(forms.Form):
	...
	taller = forms.ModelChoiceField(label='Taller', queryset=Taller.objects.filter(estado__exact=ABIERTO).filter(numeroVacantes__gt=F('numeroInscritos')).order_by('nivel','nombre'),empty_label="----Seleccionar----")
