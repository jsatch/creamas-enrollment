...
# Django settings for Creamas project.
...
#Para el admin
ADMIN_MEDIA_PREFIX = 'http://cdn.devosinc.com/static/creamas/admin/'

# URL prefix for static files.
# Example: "http://media.lawrence.com/static/"
#STATIC_URL = 'http://cdn.devosinc.com/static/creamas/'
...
SECRET_KEY = 'i25zo7$9u2&amp;ezc8%9q5t5q4-(+*q%eevo%wa=oe6o0cpm9eg14'
...
ROOT_URLCONF = 'Creamas.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'Creamas.wsgi.application'
